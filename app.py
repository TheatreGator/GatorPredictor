    ...
    if pasted_data:
        try:
            ...
            if clean_df.shape[1] >= 5:
                ...
                st.error("Please provide at least 4 columns.")
                clean_df = None
...
if clean_df is not None and not clean_df.empty:
    # Ensure proper type coercion and drop any NaNs to prevent Prophet row errors
    ...
    if len(clean_df) < 2:
        st.error("Error: The dataset has fewer than 2 valid rows after cleaning. Please check your input.")
    else:
