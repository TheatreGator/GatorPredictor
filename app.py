                ...
                if 'Weeks Out' in df_hist.columns:
                    ...
                    if rev_col:
                        ...
                        if not temp_rev.empty:
                            final_rev = temp_rev[rev_target].iloc[-1] # Absolute final gross at end of history/run
                            if final_rev > 0:
                    ...
                    if tix_col:
                        ...
                        if not temp_tix.empty:
                            final_tix = temp_tix[tix_target].iloc[-1] # Absolute final tickets at end of run
                            if final_tix > 0:
